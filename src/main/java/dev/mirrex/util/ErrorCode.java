...
public enum ErrorCode {
    ...
    CODE_NOT_NULL(21, "Required String parameter 'code' is not present"),
    EXCEPTION_HANDLER_NOT_PROVIDED(22, "Exception handler not provided"),
    REQUEST_IS_NOT_MULTIPART(23, "Current request is not a multipart request"),
    MAX_UPLOAD_SIZE_EXCEEDED(24, "Maximum upload size exceeded"),
    USER_AVATAR_NOT_NULL(25, "user avatar mustn't be null"),
    PASSWORD_NOT_VALID(26, "password not valid"),
    PASSWORD_NOT_NULL(27, "user password mustn't be null"),
    NEWS_NOT_FOUND(28, "news not found"),
    ...
    private static final Map<String, ErrorCode> ERROR_MAP = Stream.of(ErrorCode.values())
            .collect(Collectors.toMap(ErrorCode::getMessage, e -> e));
